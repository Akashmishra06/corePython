...
class BLS50_V1L_Annual_SquareOff(baseAlgoLogic):
    def runBacktest(self, portfolio, startDate, endDate):
        if self.strategyName != "BLS50_V1L_Annual_SquareOff":
...
if __name__ == "__main__":
    ...
    devName = "AK"
    strategyName = "BLS50_V1L_Annual_SquareOff"
    version = "v1"
    ...
    algoLogicObj = BLS50_V1L_Annual_SquareOff(devName, strategyName, version)
